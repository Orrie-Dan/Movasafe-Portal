...
export const PERMISSIONS = {
  ...
  FORCE_REVERSE_TRANSACTION: 'FORCE_REVERSE_TRANSACTION',
} as const
...
export const PERMISSION_CATEGORY_MAP: Record<Permission, string> = {
  ...
  [PERMISSIONS.REFUND_ESCROW]: PERMISSION_CATEGORIES.ESCROW_MANAGEMENT,
  [PERMISSIONS.RESOLVE_DISPUTE]: PERMISSION_CATEGORIES.ESCROW_MANAGEMENT,
  [PERMISSIONS.FORCE_REVERSE_TRANSACTION]: PERMISSION_CATEGORIES.DATA_MANAGEMENT,
}
...
export const ROLE_PERMISSIONS: Record<Role, Permission[]> = {
  ...
  [ROLES.ADMIN]: [
    ...
    PERMISSIONS.REFUND_ESCROW,
    PERMISSIONS.RESOLVE_DISPUTE,
    PERMISSIONS.FORCE_REVERSE_TRANSACTION,
  ],
  [ROLES.SUPPORT_STAFF]: [
    PERMISSIONS.VIEW_USERS,
    PERMISSIONS.VIEW_TRANSACTIONS,
