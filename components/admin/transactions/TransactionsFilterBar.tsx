...
export function TransactionsFilterBar({
  ...
  return (
    <Card className="sticky top-0 z-10 bg-black border-slate-800 shadow-sm">
      <CardContent className="p-4">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center gap-2">
            <Button variant="ghost" size="sm" onClick={onRefresh} className="text-white hover:bg-slate-800">
              <RefreshCw className="h-4 w-4 mr-1" />
              Refresh
            </Button>
            <Button variant="ghost" size="sm" onClick={onReset} className="text-white hover:bg-slate-800">
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5">
          ...
          <div>
            ...
            <Input
              ...
              className="h-9 text-sm bg-black border-slate-700 text-white placeholder:text-slate-500"
            />
          </div>

          {/* User Name */}
          <div>
            <Label className="text-xs text-slate-400 mb-1 block">User Name</Label>
            <Input
          ...
          {/* User Phone Number */}
          <div>
            <Label className="text-xs text-slate-400 mb-1 block">User Phone Number</Label>
            <Input
          ...
          {/* User National ID */}
          <div>
            <Label className="text-xs text-slate-400 mb-1 block">User National ID</Label>
            <Input
          ...
          <div>
            ...
            <Select
              ...
              className="h-9 text-sm bg-black border-slate-700 text-white"
            >
          ...
          <div>
            <Label className="text-xs text-slate-400 mb-1 block">Descriptions (Multi-select)</Label>
            <div className="border border-slate-700 rounded-md bg-black max-h-32 overflow-y-auto">
              <Select
                value=""
                onValueChange={handleDescriptionsChange}
                className="h-9 text-sm bg-black border-0 text-white"
              >
          ...
          <div>
            ...
            <div className="relative">
              ...
              <Input
                ...
                className="pl-8 h-9 text-sm bg-black border-slate-700 text-white placeholder:text-slate-500"
              />
            </div>
          </div>
        </div>
