...
import { Search, Moon, Bell, Settings, ChevronDown, Menu } from 'lucide-react'
...
export function DashboardHeader({ 
  ...
  return (
    <div className="sticky top-0 z-50 border-b border-slate-900 bg-black px-6 py-4">
      <div className="flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          {/* User Profile */}
          <DropdownMenu>
            <DropdownMenuTrigger className="flex items-center gap-2 text-white hover:bg-slate-800 px-3 py-2 rounded-md transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50">
