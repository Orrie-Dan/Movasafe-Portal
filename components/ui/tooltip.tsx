...
export function MetricTooltip({ children, content, side = 'top', className }: TooltipProps) {
  ...
  return (
    ...
    >
      ...
      {isVisible && (
        <div
          className={cn(
            'absolute z-50 px-2 py-1 text-xs text-white bg-slate-800 rounded shadow-lg whitespace-nowrap pointer-events-none',
            sideClasses[side],
            className
          )}
        >
