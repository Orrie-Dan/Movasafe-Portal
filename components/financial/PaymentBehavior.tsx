      ...
      <div className="grid gap-3 sm:gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <Card className="bg-black border-slate-800">
          <CardContent className="pt-6">
            ...
            <p className="text-xs text-slate-400 mt-1">Average Payment Delay</p>
          </CardContent>
        </Card>
      ...
      <div className="grid gap-4 sm:gap-6 grid-cols-1 lg:grid-cols-2">
        ...
        <Card className="bg-black border-slate-800">
          <div className="flex flex-row items-center justify-between p-4 sm:p-6 pb-3 border-b border-slate-900/50 bg-black relative">
            ...
            <div className="flex items-center justify-between relative z-10 flex-1">
              <div>
                <CardTitle size="md" className="text-white text-sm sm:text-base">Payment Status</CardTitle>
                <CardDescription className="text-slate-400 text-xs sm:text-sm">Successful vs failed payments</CardDescription>
              </div>
            </div>
          </div>
        ...
        <Card className="bg-black border-slate-800">
          <div className="flex flex-row items-center justify-between p-4 sm:p-6 pb-3 border-b border-slate-900/50 bg-black relative">
            ...
            <div className="flex items-center justify-between relative z-10 flex-1">
              <div>
                <CardTitle size="md" className="text-white text-sm sm:text-base">Top Paying Customers</CardTitle>
                <CardDescription className="text-slate-400 text-xs sm:text-sm">Highest revenue customers</CardDescription>
              </div>
            </div>
          </div>
          <CardContent className="p-4 sm:p-6">
            <div className="space-y-3">
              {data.topPayingCustomers.slice(0, 5).map((customer, idx) => (
                <div key={customer.customerId} className="p-3 rounded-lg border border-slate-700 bg-slate-900/50">
      ...
      {data.latePayments.length > 0 && (
        <Card className="bg-black border-slate-800">
          <div className="flex flex-row items-center justify-between p-4 sm:p-6 pb-3 border-b border-slate-900/50 bg-black relative">
            ...
            <div className="flex items-center justify-between relative z-10 flex-1">
              <div>
                <CardTitle size="md" className="text-white text-sm sm:text-base">Late Payments</CardTitle>
                <CardDescription className="text-slate-400 text-xs sm:text-sm">Customers with overdue payments</CardDescription>
              </div>
            </div>
          </div>
          <CardContent className="p-0 sm:p-4 sm:p-6">
            <div className="rounded-lg border border-slate-800 overflow-x-auto bg-black">
              <Table>
                <TableHeader>
                  <TableRow className="border-slate-800 bg-slate-900 hover:bg-slate-900">
                    ...
                    <TableHead className="text-slate-300 font-semibold">Total Paid</TableHead>
                    <TableHead className="text-slate-300 font-semibold">Outstanding</TableHead>
                    <TableHead className="text-slate-300 font-semibold">Delay (days)</TableHead>
                    <TableHead className="text-slate-300 font-semibold">Status</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {data.latePayments.map((customer) => (
                    <TableRow key={customer.customerId} className="border-slate-800 hover:bg-slate-800/60">
                      <TableCell className="font-medium text-white">{customer.customerName}</TableCell>
                      <TableCell className="text-white">{formatCurrency(customer.totalPaid)}</TableCell>
      ...
      {data.churnedCustomers.length > 0 && (
        <Card className="bg-black border-slate-800">
          <div className="flex flex-row items-center justify-between p-4 sm:p-6 pb-3 border-b border-slate-900/50 bg-black relative">
            ...
            <div className="flex items-center justify-between relative z-10 flex-1">
              <div>
                <CardTitle size="md" className="text-white text-sm sm:text-base">Churned Customers</CardTitle>
                <CardDescription className="text-slate-400 text-xs sm:text-sm">Customers who have stopped using services</CardDescription>
              </div>
            </div>
          </div>
          <CardContent className="p-4 sm:p-6">
