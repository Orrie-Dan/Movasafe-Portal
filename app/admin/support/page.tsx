      ...
      <Card className="bg-white dark:bg-black border-slate-200 dark:border-slate-800 max-w-lg w-full">
        <CardContent className="p-12 text-center">
          ...
          <p className="text-muted-foreground mb-6">
            A comprehensive support ticketing system is being built. Manage customer inquiries, 
            track issues, and provide excellent support all from one place.
          </p>
          <div className="flex flex-wrap justify-center gap-2 text-xs text-muted-foreground">
            <span className="px-3 py-1 rounded-full bg-slate-100 dark:bg-slate-800">Ticket Management</span>
            <span className="px-3 py-1 rounded-full bg-slate-100 dark:bg-slate-800">Live Chat</span>
            <span className="px-3 py-1 rounded-full bg-slate-100 dark:bg-slate-800">SLA Tracking</span>
            </div>
          </CardContent>
        </Card>
    </div>
