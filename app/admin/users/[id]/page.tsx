...
import { apiGetUser, apiUpdateUser, apiResetUserPassword } from '@/lib/api/users'
...
export default function UserDetailPage() {
  ...
  const handleResetPassword = async () => {
    try {
      const response = await apiResetUserPassword(userId)
      toast({
        title: 'Success',
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value: 'active' | 'suspended' | 'locked' | 'inactive') =>
